...
// 3. Authorized Static / Identity MAC Addresses (for Android 5.0.1 and older devices)
...
// 4. Authorized Phone Identity Resolving Keys (IRK) - 16 bytes each (iPhone & modern Android)
// Extract using the IRK extractor helper in tools/get_irk/ or pair once with passkey PIN
